                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form class="form-horizontal" method="POST" action="{{route('keyword.update',$keyword->id)}}">
                                @csrf
                                @method('PUT')
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="title" name="name" value="{{(isset($keyword->name))?$keyword->name:old('name')}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
